...
import { toggleModalCheckout } from "@/store/features/checkoutSlice";
export default function NavBar() {
    ...
    const openCheckoutModal  = () =>{
        dispatch(toggleModalCheckout())
    }
    return (
        <div className="bg-white w-screen border-b border-white-900" >
            <div>
                <div className="relative">
                    ...
                    <div id="md-searchbar" className={`${mdOptionsToggle ? "hidden" : "flex"} bg-white  lg:hidden py-5 px-6 items-center justify-between`}>
                        <div className="flex items-center space-x-3 text-slate-800 dark:text-white">
                            ...
                            <input type="text" placeholder="Tìm kiếm sản phẩm" className="text-sm leading-none dark:text-slate-300 dark:bg-gray-900 text-slate-600 focus:outline-none" />
                        </div>
                        <div className="space-x-6">
                            ...
                            <button aria-label="go to cart" onClick={openCheckoutModal} className="text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                    ...
                    <div className="px-6 py-9">
                        <div className="container mx-auto flex items-center justify-between">
                            <h1 className="md:w-2/12 cursor-pointer text-slate-800 dark:text-white" aria-label="the Crib.">
                            ...
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                <li>
                                    <Link href="/" className="hover:opacity-50 font-bold text-base text-black-500  hover:underline">
                                        Trang chủ
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/categories" className="hover:opacity-50 font-bold text-base text-black-500  hover:underline">
                                        Danh mục
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/about-us" className="hover:opacity-50 font-bold text-base text-black-500  hover:underline">
                                        Liên hệ
                                    </Link>
                                </li>
                                <li>
                            ...
                            <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                                <div className="hidden lg:flex items-center">
                                    ...
                                    <input id="searchInput" type="text" placeholder="Tìm kiếm sản phẩm" className={` ${searchInput ? "hidden" : ""} text-sm text-black-600 rounded ml-1 border border-transparent focus:outline-none border-gray-400 px-1`} />
                                </div>
                                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                                    ...
                                    <button aria-label="go to cart"  onClick={openCheckoutModal} >
                                ...
                                <div className="flex lg:hidden">
                                    {/* <button aria-label="show options" onClick={() => setMdOptionsToggle(!mdOptionsToggle)}>
                                        <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} absolute z-10 inset-0 md:hidden bg-white flex-col h-screen w-full`}>
                        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4 p-4">
                            <div className="flex items-center space-x-3">
                                <div>
                                    <svg className="fill-stroke text-slate-800 dark:text-white" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input type="text" placeholder="Tìm kiếm sản phẩm" className="text-sm focus:outline-none" />
                            </div>
                        ...
                        <div className="mt-6 p-4">
                            <ul className="flex flex-col space-y-6">
                                <li>
                                    <a href="#" className="hover:opacity-50 font-bold text-base text-black-500  hover:underline">
                                        Trang chủ
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="h-full flex items-end">
                            <ul className="flex flex-col space-y-8 bg-gray-50 w-full py-10 p-4 dark:bg-gray-800">
                                <li>
                                    <a href="#" className="dark:text-white text-slate-800 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        <div>
                                ...
                                <li>
                                    <a href="#" className="dark:text-white text-slate-800 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        ...
                                        <p className="text-base">Yêu thích</p>
                                    </a>
                                </li>
                            </ul>
                        </div>
